...
public class LoadBalancer implements ILoadBalancerService {
    ...
    */
    ...
    protected HashMap<String, LBVip> vips = new HashMap<>();
    protected HashMap<String, LBPool> pools = new HashMap<>();
    /*
